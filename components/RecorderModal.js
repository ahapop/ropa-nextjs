...
export default function RecorderModal({ open, recorder, company, onCancel, onSave }){
  ...
  const sectionOptions = r.division ? sectionsFor(r.division) : sectionsForCompany(company);
  const save = () => {
