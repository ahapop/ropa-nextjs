...
function _ropaCols(){
  ...
  const on4=r=>r.s4?.disclose==='มีการเปิดเผย',on5=r=>r.s5?.transfer==='มีการส่งออกนอกประเทศ';
  return [
   ...
   {g:G3,h:'บุคคลภายนอกผู้รับข้อมูล (Recipients)',f:r=>on4(r)?_xlJoin(r.s4?.recipient):''},
   {g:G3,h:'รายละเอียดผู้รับข้อมูล (Recipients Details)',f:r=>on4(r)?(r.s4?.recipientDetail||''):''},
   {g:G3,h:'สถานะของผู้รับข้อมูล (controller/processor/joint)',f:r=>on4(r)?_xlJoin(r.s4?.status):''},
   {g:G3,h:'วัตถุประสงค์ของการเปิดเผย — รายละเอียดกิจกรรม',f:r=>on4(r)?(r.s4?.purpose||''):''},
   {g:G3,h:'สัญญาที่ทำกับผู้รับข้อมูล [Contractual (y/n/na)]',f:r=>on4(r)?(r.s4?.contract||''):''},
