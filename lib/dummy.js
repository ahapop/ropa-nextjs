...
import { MASTER, DIVISIONS, SECTIONS } from "./master";
...
export function makeDummyRecords(n){
  ...
  for(let i=0;i<n;i++){
    ...
    out.unshift({
      ...
      recorder:{firstName:fn, lastName:ln, position:pick(positions), phone:'08'+Math.floor(10000000+rnd()*89999999), division:pick(DIVISIONS), section:pick(SECTIONS)},
