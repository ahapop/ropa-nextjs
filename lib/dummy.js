...
export function makeDummyRecords(n){
  ...
  for(let i=0;i<n;i++){
    ...
    out.unshift({
      ...
      recorder:{firstName:fn, lastName:ln, position:pick(positions), phone:'08'+Math.floor(10000000+rnd()*89999999)},
      ...
      s4:{disclose:'มีการเปิดเผย', recipient:pickN(MASTER.externalRecipients,1,3), recipientDetail:'บริษัทผู้ให้บริการภายนอกตามสัญญาจ้าง / หน่วยงานที่เกี่ยวข้อง',
          status:pickN(MASTER.recipientStatus,1,1), purpose:'เปิดเผยเพื่อดำเนินการตามสัญญาและข้อกำหนดทางกฎหมาย',
