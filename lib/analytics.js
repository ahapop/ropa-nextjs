...
// บริษัทที่หน่วยงานนี้ "ควรมี RoPA" — base (ไม่มีสี) ทุกบริษัทมีของตัวเอง (ชื่อซ้ำได้ แต่แยกกัน)
//  · สายสีเหลือง → EBM · สายสีชมพู → NBM · base → ครบทั้ง 4 บริษัท
function orgCompanies(org){ const c = companiesForOrg(org); return (c.length===1 && c[0]==="BTSC") ? ["BTSC","BID","EBM","NBM"] : c; }
