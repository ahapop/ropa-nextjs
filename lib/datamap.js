...
export function buildMapSVG(r){
  ...
  NOTE.push(dmNoteEl(ent.x, ent.y+ent.h+11, 'เมนู ระยะเวลาในการเก็บรักษาข้อมูล → ประเภทการเก็บรักษา'));
  ...
  NOTE.push(dmNoteEl(ent.x, retY-39, '→ แต่ละประเภท: เริ่มนับจากระยะเวลา → ระยะเวลาที่เก็บรักษา'));
